...
public class MainWindowControler extends AbstractControler implements Initializable {
    ...
    private void setUpEmailsTableView() {
        ...
        sizeCol.setCellValueFactory((new PropertyValueFactory<EmailMessage, SizeInteger>("size")));        dateCol.setCellValueFactory((new PropertyValueFactory<EmailMessage, Date>("date")));
    }
