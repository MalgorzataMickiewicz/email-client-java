package com.mm.controler.services;

import com.mm.model.EmailTreeItem;
import com.mm.view.IconResolver;
...
public class FetchFoldersService extends Service<Void> {
    ...
    private void handleFolders(Folder[] folders, EmailTreeItem<String> foldersRoot) throws MessagingException {
        for(Folder folder: folders){
            ...
            addMessageListinerToFolder(folder, emailTreeItem);
    ...
    private void addMessageListinerToFolder(Folder folder, EmailTreeItem<String> emailTreeItem) {
